  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="B2C Car Sharing: Empowering individual customers to book nearby cars with ease, managed seamlessly by our dedicated operations staff from centralized dashboards."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`B2C Car Sharing: Empowering individual customers to book nearby cars with ease, managed seamlessly by our dedicated operations staff from centralized dashboards.`}
            </Text>
            <Box
