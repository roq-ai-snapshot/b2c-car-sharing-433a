...
export function OperationListPage(props: OperationListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('car_name', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'car_name',
          header: 'Car Name',
          accessorKey: 'car_name',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/car-names/view/${record.car_name?.id}`}>
              {record.car_name?.model}
            </Link>
          ),
        }
      : null,
