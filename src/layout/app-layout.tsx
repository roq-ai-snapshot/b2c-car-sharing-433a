...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'fleet-manager', 'admin', 'customer', 'operations-staff', 'business-owner', 'manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Car Names', path: '/car-names', entity: 'car_name', service: AccessServiceEnum.PROJECT, icon: FiBox },
