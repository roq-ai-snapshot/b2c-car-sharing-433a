...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create.create': {
    roles: ['owner', 'fleet-manager', 'admin', 'operations-staff', 'business-owner', 'manager'],
    key: 'bookingId',
    tenantPath: [],
    userPath: [],
  },
  'vehicle.create.create': {
    roles: ['owner', 'admin', 'operations-staff', 'business-owner', 'manager'],
    key: 'vehicleId',
    tenantPath: [],
    userPath: [],
  },
  'maintenance.schedule.update': {
    roles: ['owner', 'fleet-manager', 'admin', 'business-owner', 'manager'],
    key: 'maintenanceId',
    tenantPath: [],
    userPath: [],
  },
